...
### grub2向kernel传参的规范
linux的引导协议(boot protocol), 在[Documentation/x86/boot.rst](https://elixir.bootlin.com/linux/v5.8-rc4/source/Documentation/x86/boot.rst)
