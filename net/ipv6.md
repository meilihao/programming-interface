...
> ipv6的前缀和ipv4的子网掩码类似, 均标识同一网络上的ip地址范围.
...
### 报头
![IPv6 Fixed Header](/misc/img/net/IPv6_header.jpg)
...
### 扩展报头
![RFC 2460定义的必须支持的扩展报头](/misc/img/net/ipv6_extension_headers.jpg)
...
![扩展报头的顺序](/misc/img/net/ipv6_extension_headers_sequence.jpg)
